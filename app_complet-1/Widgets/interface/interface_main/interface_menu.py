...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.frame.setGeometry(QRect(0, 0, 831, 521))
        ...
        self.label.setPixmap(QPixmap(u":/IMG/diamond.png"))
        self.label.setScaledContents(True)
        self.label_2 = QLabel(self.widget)
        self.label_2.setObjectName(u"label_2")
        self.label_2.setGeometry(QRect(40, 169, 181, 21))
        font = QFont()
        ...
        self.pushButton_2.setGeometry(QRect(-10, 300, 261, 61))
        font1 = QFont()
...
"}")
        icon = QIcon()
        icon.addFile(u":/IMG/orange.png", QSize(), QIcon.Normal, QIcon.Off)
        self.pushButton_2.setIcon(icon)
        self.pushButton_2.setIconSize(QSize(30, 30))
        self.label_3 = QLabel(self.widget)
        self.label_3.setObjectName(u"label_3")
        self.label_3.setGeometry(QRect(90, 190, 71, 20))
        self.label_3.setStyleSheet(u"color:white")
        self.pushButton_15 = QPushButton(self.widget)
        self.pushButton_15.setObjectName(u"pushButton_15")
        self.pushButton_15.setGeometry(QRect(10, 240, 241, 61))
...
"}")
        icon1 = QIcon()
        icon1.addFile(u":/IMG/worldwide.png", QSize(), QIcon.Normal, QIcon.Off)
        self.pushButton_15.setIcon(icon1)
        self.pushButton_15.setIconSize(QSize(30, 30))
        self.pushButton_3 = QPushButton(self.widget)
        self.pushButton_3.setObjectName(u"pushButton_3")
        self.pushButton_3.setGeometry(QRect(-30, 360, 281, 61))
...
"}")
        icon2 = QIcon()
        icon2.addFile(u":/IMG/diamond.png", QSize(), QIcon.Normal, QIcon.Off)
        self.pushButton_3.setIcon(icon2)
        self.pushButton_3.setIconSize(QSize(30, 30))
        self.pushButton = QPushButton(self.widget)
        self.pushButton.setObjectName(u"pushButton")
        self.pushButton.setGeometry(QRect(10, 420, 241, 61))
...
"}")
        icon3 = QIcon()
        icon3.addFile(u":/IMG/[cloud.png", QSize(), QIcon.Normal, QIcon.Off)
        self.pushButton.setIcon(icon3)
        self.pushButton.setIconSize(QSize(30, 30))
        self.widget_2 = QWidget(self.frame)
        self.widget_2.setObjectName(u"widget_2")
        self.widget_2.setGeometry(QRect(240, 0, 591, 521))
...
"} ")
        icon4 = QIcon()
        icon4.addFile(u":/IMG/add (1).png", QSize(), QIcon.Normal, QIcon.Off)
...
"} ")
        icon5 = QIcon()
        icon5.addFile(u":/IMG/layers.png", QSize(), QIcon.Normal, QIcon.Off)
...
"} ")
        icon6 = QIcon()
        icon6.addFile(u":/IMG/stock-exchange-app.png", QSize(), QIcon.Normal, QIcon.Off)
...
"} ")
        icon7 = QIcon()
        icon7.addFile(u":/IMG/graphic-design.png", QSize(), QIcon.Normal, QIcon.Off)
...
"} ")
        icon8 = QIcon()
        icon8.addFile(u":/IMG/android-logo.png", QSize(), QIcon.Normal, QIcon.Off)
